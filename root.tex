...
We will conclude that combining \acrshort{rnaseq} expression data with pathological images will aid in the development of a predictive model for early detection of \acrshort{oscc}.
...
Accumulative knowledge shows that some driver genes could facilitate carcinogenesis in \acrshort{oscc}.
...
The mutations of TP53 are one of the most frequent abnormalities in \acrshort{hnscc} found within up to 70\% of surgical specimen~\citep{Alsner2001, Singh2016, Wang2017, WARD2018}.
It is also found in severe dysplasia of \acrshort{ovh}.
Overexpression of Ki-67 (encoded by MKI67 gene)~\citep{Perisanidis2012,Szentkuti2015} impacts on poor overall survival of HNSCC.
...
They found that FAT1 genetic mutation rate is significantly higher in progressive \acrshort{ovh} (83.3\%) than in their non-progressive counter partner (22.2\%), while 6.25\% of TP53 is mutated in \acrshort{ovh}. 
...
Missense mutation of FAT1 is also found in progressive \acrshort{ovh} and poor recurrence-free survival of oral cancer.
...
Clinically helpful biomarkers for dysplasia grading include KRT13 (type I cytoskeletal 13, encoding CK13), KRT17 (type I cytoskeletal 17, encoding CK17), TP53 (encoding p53), MKI67 (Marker Of Proliferation Ki-67, encoding Ki-67).
