...
A predictive biomarker of \acrshort{ovh} gives early alarm before its malignant transformation, which prevents unnecessary biopsy repeatedly, for improvement of patient's survival.
...
Overexpression of CAMK2N1 is significantly associated with the poor prognosis of \acrfull{os}. 
Missensed mutation of FAT1 is also found in progressive \acrshort{ovh} and poor recurrence-free survival of oral cancer.
...
We assume these biomarkers should be found around the surgical margin of \acrshort{oscc} specimen.
Oral cancer risk is influenced by the severity of epithelial dysplasia on \acrshort{ovh} samples.
Clinically helpful biomarkers for dysplasia grading include CK13, CK17, TP53, and Ki67.

% from sp1 研究構想： Dr Wu 吳明恆老師
Our previous studies demonstrated a high malignant potential of oral verrucous hyperplasia (OVH)  (Head Neck 2018, Head Neck 2020 and Medicine 2021). WES (whole-exome sequencing) analysis  identify that FAT1 genetic mutation rate was strikingly higher in progressive OVH (83.3\%) than in  non-progressive ones (22.2\%) while tp53, the critical genome guardian, was mutated only in one non progressive OVH (6.25\% mutation rate in all OVH samples). Therefore, it is hypothesized that FAT1- mutated OVH is committed to OSCC and tp53 could be a gatekeeper for OVH transformation. A  sequential genetic alteration (from FAT1 to tp53) may drive OVH transformation. 
In addition, although  no publication exactly indicates the relationships between FAT1 and tp53, the reciprocal crosstalk  between the p53 and FAT1-regulated YAP1/Hippo pathways has been well addressed. 
...
Further validation will be conducted by using deep learning of whole-slide pathological images.
% are warranted 

%%%%%%%%%%%

% *****specific Aims (old SP3 + sp4)	
...
To identify genetic variants associated with malignant transformation of OVH by implementing genome-wide association testing.
...
\item \textbf{Aim 3}: 
To develop risk prediction model for malignant transformation of OVH by integrating risk factors identified from all subprojects. sp1, sp2, sp3.
...
% from sp1
\item Aim 1. To verify the FAT1 gene mutation in an independent cohort of progressive and non progressive OVH samples using targeted gene NGS 

\item Aim 2. To compare the transcriptome of FAT1 wild-type and mutant OVH tissues. 

\item Aim 3. To dissect the cooperative effect of FAT1 and tp53 gene mutation on OVH  transformation. 
\item Aim 4. To analyze the effect of mutated FAT1 on the reciprocal relationship of YAP1 and tp53  pathways in progressive OVH cells by the analysis of YAP1 and p53-regulated transcriptome and genome-binding regions.
...
we could validate and find more biomarkers from holistic \acrshort{ehr} and pathology images by the way of deep learning under R/Pytorch/Keras framework.\\[2.5cm]
