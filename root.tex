...
\begin{ganttchart}[
   ...
   \ganttbar[
    ...
    name=pp
   ]{IRB application}{2022-05}{2022-10} \\ % name=pp
...
% ganttlinkedbar
\ganttbar[progress=20, name=T1A]{Retrospective cohorts \textcircled{\raisebox{-0.9pt}{A}} and \textcircled{\raisebox{-0.9pt}{B}}
}{2022-09}{2023-07} \\
...
\ganttbar[progress=15, name=T2A]{Implementing genome-wide association testing (GWAS)}{2022-9}{2023-12} \\ % 因Covid-19，臨床研究資料庫獨立作業區2021.05.19暫停服務
...
\ganttgroup{Aim 3}{2022-08}{2023-12} \\
  \ganttbar[progress=20, name=T3A]{Construct a deep learning platform for pathology images}{2022-08}{2023-12}
      \ganttnewline
  \ganttbar[progress=30, name=T3B]{$=>$Train models on TWCC super computer}{2022-10}{2022-12}
  \ganttbar[progress=0, name=T3C]{}{2023-02}{2023-04}
    \ganttbar[progress=0, name=T3D]{}{2023-06}{2023-07}
    \ganttnewline
%  \ganttnewline
...
\end{ganttchart}
    ...
    \caption{\cntext{執行進度} (OVH and leukoplakia cohorts from \textcircled{\raisebox{-0.9pt}{A}} Chi-Mei Hospital, \textcircled{\raisebox{-0.9pt}{B}} and \textcircled{\raisebox{-0.8pt}{C}} Taipei Medical University Hospital); \cntext{TWCC 超級電腦的計算額度，分為三個階段使用} (99000, 99000, 49500)
